...
G=["","We would like to thank the Centre of Sleep and Chronobiology, University of Toronto","for the original concept of the Sleep Disorder Patient Chart","originated by Moldofsky/MacFarlane \u00a9 1990",""];a.text(F.concat(G,["Please send feedback to","Software version: 01b06cc/"+d,"Report version: 20210606"]),20,150);a.setTextColor(0,0,255);a.textWithLink("github.com/sleepdiary",67.2,150+4.875*(F.length+G.length)-.1,{url:"https://sleepdiary.github.io"});a.setTextColor(0);a.setFont("Courier");a.text(B[0].id.split("T")[0],
